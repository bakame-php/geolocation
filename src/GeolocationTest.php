...
final class GeolocationTest extends TestCase
{
    ...
    private array $coordinatesOfAntwerp = ['lat' => 51.260197, 'lng' => 4.402771];
    ...
    public function it_can_be_instantiated_from_geo_hash(): void
    {
        ...
        $locationHash = Geolocation::fromGeoHash('u155s5wh21');
     ...
     * @test
     */
    public function it_exposes_some_properties(): void
    {
    ...
    public function it_returns_null_if_no_sunrise_is_possible(): void
    {
        ...
        self::assertNull($location->sunrise($now));
    }
    ...
    public function it_returns_null_if_no_sunset_is_possible(): void
    {
        ...
        self::assertSame('gzzzzzzzzzzz', $location->geoHash());
        self::assertNull($location->sunset($now));
    }
